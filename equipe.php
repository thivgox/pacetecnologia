    ...
    <div class="container">
        ...
        <div class="swot-grid">
            <div class="swot-item swot-s">
                ...
                <ul>
                    <li>Agilidade para desenvolver e entregar MVPs</li>
                    <li>Uso consistente de metodologias ágeis</li>
                    <li>Foco em inovação e escalabilidade</li>
                    <li>Cultura de respeito e empatia</li>
                    <li>Posicionamento como parceira estratégica</li>
                </ul>
            </div>
            ...
            <div class="swot-item swot-w">
                ...
                <ul>
                    <li>Dependência de clientes em estágio inicial</li>
                    <li>Limitação da capacidade da equipe para escalar múltiplos projetos</li>
                    <li>Visibilidade reduzida da marca</li>
                    <li>Equilíbrio entre missão social e demandas comerciais</li>
                </ul>
            </div>
            ...
            <div class="swot-item swot-o">
                ...
                <ul>
                    <li>Avanço do ecossistema de startups no Brasil</li>
                    <li>Crescente demanda por terceirização tecnológica</li>
                    <li>Parcerias com incubadoras e aceleradoras</li>
                    <li>Desenvolvimento de produtos próprios</li>
                    <li>Expansão em soluções escaláveis</li>
                </ul>
            </div>
            ...
            <div class="swot-item swot-t">
                ...
                <ul>
                    <li>Competição intensa no setor tecnológico</li>
                    <li>Oscilações no mercado de startups</li>
                    <li>Desafios de segurança e conformidade</li>
                    <li>Necessidade de atualização tecnológica contínua</li>
                </ul>
            </div>
        </div>
    </div>
